  ...
  const personalData = [
    {
      ...
      title: "Email",
      value: "theankitmishra8657@gmail.com",
      link: "theankitmishra8657@gmail.com",
    },
    {
      icon: <IoMdCall />,
      title: "Phone",
      value: "+91 8657833001",
      link: "tel:+918657833001",
    },
    {
      icon: <SlCalender />,
      title: "BirthDay",
      value: "August 27, 2002",
      link: null, 
    },
    {
      icon: <CiLocationOn />,
    ...
    <div className="border sm:p-9 rounded-2xl shadow-lg">
      ...
      <div className="flex justify-between items-center gap-5 p-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-thin tracking-tighter">Ankit Mishra</h1>
